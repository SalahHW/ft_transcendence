export default class HomePage {
	...
	render(): void {
		...
		this._video = this._container.querySelector<HTMLVideoElement>('#background-video');
		if (this._video) {
