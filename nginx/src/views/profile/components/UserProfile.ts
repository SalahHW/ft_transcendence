                ...
                <div class="flex gap-2 h-full overflow-auto">
                    ...
                    <div class="flex-[2] rounded-lg p-4 flex flex-col justify-start items-start">
                        ...
                        <div class="flex items-center gap-2 mb-4">
                            <p class="text-gray-500">${user.wallet ? UserProfile.truncateWallet(user.wallet) : 'No wallet'}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex-[1] rounded-lg p-4 aspect-square flex">
                        ${createWinRateDonutChart({
                            wins: matches.totalwins,
                            losses: matches.totallosses
                        })}
                    </div>
                </div>
            `;
            ...
            return /* HTML */`
                <div class="flex gap-2 h-full overflow-auto">
                    <div class="flex-[1] rounded-lg p-4 flex items-center justify-center">
                        <p class="text-red-500">Erreur lors du chargement du profil utilisateur</p>
                    </div>
                </div>
            `;
        }
    ...
    public static async addEventListeners(): Promise<void> {
        ...
        try {
            ...
            const editHandler = () => {
                ...
                // Create email input if email wrapper exists
                if (emailWrapper) {
