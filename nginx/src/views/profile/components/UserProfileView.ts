					...
					if (save) {
						...
						if (newUsername && newUsername !== originalUsername) {
							try {
								...
								NotificationService.show("Username updated successfully!", "success");
							} catch (error) {
								console.error("Error updating username:", error);
								NotificationService.show("Error updating username", "error");
								save = false;
							}
						}
						...
						if (emailInput && newEmail && newEmail !== originalEmail) {
							try {
								...
								NotificationService.show("Email updated successfully!", "success");
							} catch (error) {
								console.error("Error updating email:", error);
								NotificationService.show("Error updating email", "error");
								save = false;
							}
						}
						...
						if (avatarChanged && newAvatarFile) {
							try {
								...
								NotificationService.show("Error updating avatar", "error");
								save = false;
							}
						}
					}
